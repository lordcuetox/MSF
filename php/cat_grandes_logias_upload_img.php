...
if (isset($_POST['xAccion2'])) {
    if ($_POST["xAccion2"] == "upload") {
        ...
        $cve_gran_logia = isset($_POST['xCveGranLogia']) ? $_POST['xCveGranLogia'] : 0;
        $target_dir = "../img/grandes_logias/";
        ...
        $new_name_file = $cve_gran_logia . $extension;
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                $sql = "UPDATE grandes_logias SET foto = '" . (substr($target_file, 3, strlen($target_file))) . "' WHERE cve_gran_logia = $cve_gran_logia";
        ...
        header('Location:cat_grandes_logias.php');
        return;
    }
}
?>
<div class="modal-header">
    ...
    <h4 class="modal-title">Grandes Logias | Subir imagen</h4>
</div>
    ...
    <div class="te">
        <form role="form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data" id="frmUpload" name="frmUpload">
            <div class="form-group">
                <input type="hidden" id="xCveGranLogia" name="xCveGranLogia" value="<?php echo($_GET["xCveGranLogia"]); ?>" />
