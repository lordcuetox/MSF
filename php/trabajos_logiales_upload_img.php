    ...
    if ($_POST["xAccion2"] == "upload") {
        ...
        if (!$exito) {
            ...
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                $sql = "UPDATE volumenes SET imagen = '" . (substr($target_file, 3, strlen($target_file))) . "' WHERE cve_volumen = $cve_volumen";
...
<div class="modal-header">
    ...
    <h4 class="modal-title">Trabajos logiales | Subir imagen</h4>
</div>
