...
<table class="table table-bordered table-striped table-hover table-responsive">
    ...
    <tbody>
        <?php
        $sql = "select gl.cve_gran_logia,ri.descripcion as rito,gl.nombre,gl.activo from grandes_logias gl inner join grandes_orientes ori on ori.cve_oriente=gl.cve_oriente inner join ritos ri on ri.cve_rito=gl.cve_rito where gl.activo=1 and gl.cve_oriente=$cveOriente";
